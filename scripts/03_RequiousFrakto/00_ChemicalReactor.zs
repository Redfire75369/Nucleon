...
global addChemicalReactorRecipe as function(IItemStack, IIngredient[], ILiquidStack[], int, int) as void = function(output as IItemStack, inputs as IIngredient[], fluidInputs as ILiquidStack[], energy as int, ticks as int) as void {
...
addChemicalReactorRecipe(<minecraft:cobblestone>, [<minecraft:stone>], [<liquid:water> * 50], 8000, 40);