...
mods.rustichromia.Quern.add("sawdust", [oreDict["logWood"]], [hashDust["Wood"].firstItem * 4], 1, 1.0/0, 100); 

mods.rustichromia.Gin.add("copper_wire", [hashIngot["Copper"]], [oreDict["wireCopper"].firstItem], [hashNugget["Copper"].firstItem], 1, 1.0/0, 200);
...
recipes.addShaped("big_windmill_rustichromia", <rustichromia:windmill_big>, [
	[<rustichromia:windmill_blade>, <rustichromia:windmill_blade>, <rustichromia:windmill_blade>],
	[<rustichromia:windmill_blade>, <contenttweaker:reinforced_stone_gear>, <rustichromia:windmill_blade>],
	[<rustichromia:windmill_blade>, <rustichromia:windmill_blade>, <rustichromia:windmill_blade>]
]);
