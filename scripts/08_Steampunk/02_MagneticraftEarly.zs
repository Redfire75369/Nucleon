...
mods.rustichromia.Assembler.add("pump_mechanism", 2, [hashNugget["Terne"].firstItem * 6, <glassential:glass_redstone> * 2, <minecraft:piston>], [<techguns:itemshared:72>], 15, 1.0/0, 400);

mods.immersiveengineering.MetalPress.addRecipe(<minecraft:brick_block>, hashIngot["Brick"], <contenttweaker:mold_flat>, 2048, 4);
...
/*** Others ***/
changeRecipeShaped("fabricator", <magneticraft:fabricator>, [
	[hashIngot["Terne"], hashIngot["Terne"], hashIngot["Terne"]],
	[hashGear["Lead"], oreDict["workbench"], hashGear["Lead"]],
	[<glassential:glass_redstone>, oreDict["lightPlateIron"], <glassential:glass_redstone>]
]);
...
changeRecipeShaped("airlock", <magneticraft:airlock>, [
	[<glassential:glass_redstone>, <techguns:itemshared:72>, <glassential:glass_redstone>],
	[<minecraft:bucket>, <magneticraft:multiblock_parts>, <minecraft:bucket>],
	[<glassential:glass_redstone>, <immersiveengineering:metal_device0:4>, <glassential:glass_redstone>]
]);
...
changeRecipeShaped("tube_light", <magneticraft:tube_light>, [
	[hashRod["Iron"], hashPlate["Iron"], hashRod["Iron"]],
	[hashNugget["Copper"], hashDust["Glowstone"], hashNugget["Copper"]]
]);
...
changeRecipeShaped("thermopile", <magneticraft:thermopile>, [
	[hashIngot["RefinedIron"], oreDict["lightPlateCopper"], hashIngot["RefinedIron"]],
	[oreDict["lightPlateCopper"], <ematter:seebeck_generator> ,oreDict["lightPlateCopper"]], 
	[hashIngot["RefinedIron"], oreDict["lightPlateCopper"], hashIngot["RefinedIron"]],
]);

changeRecipeShaped("electric_heater", <magneticraft:electric_heater>, [
	[hashPlate["Terne"], <magneticraft:heat_sink>, hashPlate["Terne"]],
	[hashPlate["Terne"], <magneticraft:multiblock_parts:2>, hashPlate["Terne"]],
	[<magneticraft:crafting:3>, <embers:superheater>, <magneticraft:crafting:3>]
]);
changeRecipeShaped("rf_heater", <magneticraft:rf_heater>, [
	[hashPlate["Steel"], <magneticraft:heat_sink>, hashPlate["Steel"]],
	[hashPlate["Steel"], <immersiveengineering:metal_device1:1>, hashPlate["Steel"]],
	[<immersiveengineering:metal_decoration0:3>, <techreborn:part:13>, <immersiveengineering:metal_decoration0:3>]
]);
...
changeRecipeShaped("electric_transformer", <magneticraft:rf_transformer>, [
	[hashIngot["Terne"], hashIngot["Copper"], hashIngot["Terne"]],
	[hashPlate["Steel"], <glassential:glass_redstone>, hashPlate["Steel"]],
	[<magneticraft:crafting:1>, hashIngot["RefinedIron"],<magneticraft:crafting:1>]
]);
